...
import { useGetServiceCategoriesQuery, useGetServicesQuery } from '@/store/apiSlice';
...
const { data, isLoading, error } = useGetServicesQuery({
  ...
  const {data:categories, isLoading:categoriesLoading, error:categoriesErr} = useGetServiceCategoriesQuery({});
